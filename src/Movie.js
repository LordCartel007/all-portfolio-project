const movieList = [
  {
    ...
    description:
      "A Car ecommerce store built for IkeShalom import and export company with working payment system using flutter wave and admin dashboard that store payment orders and to edit the products in the store. It has a private domain and seo optimization. Real time messaging system with socket.io , a 3d carousel and horizontal carousel, images are hosted with aws s3 bucket. It is also responsive on all screen size. Users data are stored on MongoDb.",
